...
{
    public class ChestTestTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            AddMapEntry(new Color(200, 200, 200), "Red Chest", MapChestName);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.showItemIcon2 = mod.ItemType("ChestTestItem");         //here put your Chest Item name
