...
namespace NinMod.Tiles{
    public class Miner_Block_MK2 : Miner_Block{
        public override void SetDefaults(){
            base.drillTimeout = 60 * 3;
            base.width = 5;
            base.spelunkerWidth = 11;
            base.spelunkerEfficiency = 1.5f;
            ...
            AddMapEntry(new Color(200, 200, 200), "Improved Miner");
            dustType = mod.DustType("Pixel");
            this.animationFrameHeight = 74;
        }

        public override void KillMultiTile(int i, int j, int frameX, int frameY) {
            Item.NewItem(i * 16, j * 16, 32, 32, mod.ItemType("Miner_Item_MK2"));
        ...
        public override void DrawEffects(int i, int j, SpriteBatch spriteBatch, ref Color drawColor, ref int nextSpecialDrawIndex) {
            ...
            if (tile.frameX == 0 && (tile.frameY % this.animationFrameHeight) == 0) {
                Dust.NewDust(new Vector2(i * 16 + 5*16/2-4, j * 16 + 4*16), 1, 1, 0);
            }
        }
    }
}
