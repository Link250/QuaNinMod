		...
		public override void AI()
		{
			...
			if(!foundTarget){
				...
				foreach(NPC n in Main.npc){
					if(n.Distance(projectile.position) < nearest.Distance(projectile.position) && n.life>0)nearest = n;
				}
               ...
               // Terraria.Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.velocity.X, projectile.velocity.Y, 638, 1, 15f, Main.myPlayer);
			}
		}
	}
}
